...
const EditProfile = () => {
  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      ...
      if (instagram) formData.append("instagramUrl", formatUrl(instagram, "instagram"));
      if (youtube) formData.append("youtubeUrl", formatUrl(youtube, "youtube"));
      if (spotify) formData.append("spotifyArtistUrl", formatUrl(spotify, "spotify"));
      ...
      setErrorMsg(errorResponse?.error || error?.message || "Something went wrong. Please try again.");
    } finally {
      setLoading(false);
    }
  };
